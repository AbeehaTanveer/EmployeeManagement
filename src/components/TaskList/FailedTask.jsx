...
const FailedTask = ({task}) => {
  console.log("New Task",task.taskTitle)
  return (
    <div>
      
      <Card sx={{ minWidth: "400px", height: "340px", p: 2, backgroundColor: '#4c49ea', borderRadius: "8%" }}>
...
<Button fullWidth color='error' variant='contained' size='small' sx={{mt:5}}> Failed Task </Button>
